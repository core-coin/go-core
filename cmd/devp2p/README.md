...
Use `devp2p enrdump <base64>` to verify and display an Core Node Record.
...
The Xcb Protocol test suite is a conformance test suite for the [xcb protocol][xcb].

To run the xcb protocol test suite against your implementation, the node needs to be initialized as such:

1. initialize the gocore node with the `genesis.json` file contained in the `testdata` directory
2. import the `halfchain.rlp` file in the `testdata` directory
3. run gocore with the following flags:
```
gocore --datadir <datadir> --nodiscover --nat=none --networkid 19763 --verbosity 5
```
...
[dns-tutorial]: https://gocore.coreblockchain.cc/docs/developers/dns-discovery-setup
[discv4]: https://github.com/core/devp2p/tree/master/discv4.md
[discv5]: https://github.com/core/devp2p/tree/master/discv5/discv5.md
