...
const (
	ipcAPIs  = "admin:1.0 cryptore:1.0 debug:1.0 xce:1.0 miner:1.0 net:1.0 personal:1.0 rpc:1.0 shh:1.0 txpool:1.0 web3:1.0"
	httpAPIs = "xce:1.0 net:1.0 rpc:1.0 web3:1.0"
)
