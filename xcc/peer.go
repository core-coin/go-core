...
//
// This method is legacy support for initial transaction exchange in xcc/64 and
// prior. For xcc/65 and higher use SendPooledTransactionHashes.
...
// Handshake executes the xcc protocol handshake, negotiating version number,
