...
func TestPendingTxFilter(t *testing.T) {
	t.Parallel()
	addr, err := common.HexToAddress("cb75b794f5ea0ba39494ce83a213fffba74279579268")
	if err != nil {
		t.Error(err)
	}
	var (
...
func TestLogFilter(t *testing.T) {
	...
	var (
		...
		firstAddr, err1      = common.HexToAddress("cb711111111111111111111111111111111111111111")
		secondAddr, err2     = common.HexToAddress("cb212222222222222222222222222222222222222222")
		thirdAddress, err3   = common.HexToAddress("cb683333333333333333333333333333333333333333")
		notUsedAddress, err4 = common.HexToAddress("cb599999999999999999999999999999999999999999")
