...
func TestCreate2Addreses(t *testing.T) {
	...
	for i, tt := range []testcase{
		{
			origin:   "cc970000000000000000000000000000000000000000",
			salt:     "0x0000000000000000000000000000000000000000",
			code:     "0x00",
			expected: "cc54aa3a3014cdc5add570af298e8bedce1894b1bb1e",
		},
		{
			origin:   "cc77deadbeef00000000000000000000000000000000",
			salt:     "0x0000000000000000000000000000000000000000",
			code:     "0x00",
			expected: "cc54852a09bee2f9a6ca57f80ba1a730938ee078efaf",
		},
		{
			origin:   "cc77deadbeef00000000000000000000000000000000",
			salt:     "0xfeed000000000000000000000000000000000000",
			code:     "0x00",
			expected: "cc464a1888794118e35514b5b04380378c0672774a5b",
		},
		{
			origin:   "cc970000000000000000000000000000000000000000",
			salt:     "0x0000000000000000000000000000000000000000",
			code:     "0xdeadbeef",
			expected: "cc87e917a4c3348668cb66a07cd173674ad7bc195aaa",
		},
		{
			origin:   "cc3300000000000000000000000000000000deadbeef",
			salt:     "0xcafebabe",
			code:     "0xdeadbeef",
			expected: "cc83db27a33891fa48c5092e787db6be0a3eb815678e",
		},
		{
			origin:   "cc3300000000000000000000000000000000deadbeef",
			salt:     "0xcafebabe",
			code:     "0xdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeef",
			expected: "cc6695d03b71bddec5c6e6253e945bb7fbe1ba20d1e1",
		},
		{
			origin:   "cc970000000000000000000000000000000000000000",
			salt:     "0x0000000000000000000000000000000000000000",
			code:     "0x",
			expected: "cc84d24887a01a7714a4afc325742e898dd82c2fd13e",
		},
	} {
