...
func journalProgress(db xcbdb.KeyValueWriter, marker []byte, stats *generatorStats) {
...
// gocoreering and logging, since the method surfs the blocks as they arrive, often
// being restarted.
