...
type Tree struct {
	diskdb xcedb.KeyValueStore      // Persistent database to store the snapshot
...
// background thread.
func New(diskdb xcedb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, async bool) *Tree {
