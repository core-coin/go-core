...
func wipeSnapshot(db xcedb.KeyValueStore, full bool) chan struct{} {
...
func wipeContent(db xcedb.KeyValueStore) error {
...
func wipeKeyRange(db xcedb.KeyValueStore, kind string, prefix []byte, keylen int) error {
