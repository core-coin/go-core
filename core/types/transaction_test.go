...
var (
	address, errAddr = common.HexToAddress("cb10095e7baea6a6c7c4c2dfeb977efac326af552d87")
...
func TestTransactionSigHash(t *testing.T) {
	...
	if nucleus.Hash(emptyTx) != common.HexToHash("0x954d497efd06a9fc35d425d3b64c4d161dfa4891598e9741dfb26011d9aea3d3") {
		t.Errorf("empty transaction hash mismatch, got %x", emptyTx.Hash())
	}
	if nucleus.Hash(rightvrsTx) != common.HexToHash("0x163ed54b32e39859befc5d15848ab6ba016cc3f8686b0fd27f4631c065967f19") {
...
func TestTransactionEncode(t *testing.T) {
	...
	should := common.FromHex("")
...
func TestRecipientEmpty(t *testing.T) {
	...
	expected, err := common.HexToAddress("cb46089200aa2a542254e53814647e9fa2f8e03ad44c")
	if err != nil {
		t.Fatal(err)
	}
	if expected != from {
