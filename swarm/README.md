...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/core-coin/go-core

    go install github.com/core-coin/go-core/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/core-coin/go-core`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/core-coin/go-core
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/core-coin/go-core/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/core-coin/go-core/wiki/Code-Review-Guidelines).
