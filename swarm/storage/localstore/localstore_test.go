...
import (
	...
	ch "github.com/core-coin/go-core/swarm/chunk"
...
//
// # go test -benchmem -run=none github.com/core-coin/go-core/swarm/storage/localstore -bench BenchmarkNew -v -timeout 20m
// goos: darwin
// goarch: amd64
