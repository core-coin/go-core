...
For prerequisites and detailed build instructions please read the [Installation Instructions](https://github.com/core-coin/go-core/wiki/Building-Ethereum) on the wiki.
...
[CLI Wiki page](https://github.com/core-coin/go-core/wiki/Command-Line-Options)),
...
and [`geth` specific APIs](https://github.com/core-coin/go-core/wiki/Management-APIs)).
