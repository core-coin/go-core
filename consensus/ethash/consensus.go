...
var (
	FrontierBlockReward       = big.NewInt(5e+18) // Block reward in ore for successfully mining a block
	ByzantiumBlockReward      = big.NewInt(3e+18) // Block reward in ore for successfully mining a block upward from Byzantium
	ConstantinopleBlockReward = big.NewInt(2e+18) // Block reward in ore for successfully mining a block upward from Constantinople
...
// rules of the stock Core ethash engine.
...
func (ethash *Ethash) verifySeal(chain consensus.ChainReader, header *types.Header) error {
	...
	digest, result = hashcryptonight(ethash.SealHash(header).Bytes(), header.Nonce.Uint64())
