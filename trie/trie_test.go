...
func (s *spongeDb) NewIterator() xcbdb.Iterator { panic("implement me") }
func (s *spongeDb) NewIteratorWithStart(start []byte) xcbdb.Iterator { panic("implement me") }
func (s *spongeDb) NewIteratorWithPrefix(prefix []byte) xcbdb.Iterator { panic("implement me") }
