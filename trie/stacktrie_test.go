...
func genTxs(num uint64) (types.Transactions, error) {
	key, err := crypto.UnmarshalPrivateKeyHex("ab856a9af6b0b651dd2f43b5e12193652ec1701c4da6f1c0d2a366ac4b9dabc9433ef09e41ca129552bd2c029086d9b03604de872a3b343204")
	if err != nil {
		return nil, err
	}
	newTx := func(i uint64) (*types.Transaction, error) {
		signer := types.NewNucleusSigner(big.NewInt(18))
		tx, err := types.SignTx(types.NewTransaction(i, key.Address(), new(big.Int), 0, new(big.Int).SetUint64(10000000), nil), signer, key)
		return tx, err
	}
