...
import (
	...
	"github.com/core-coin/go-core/v2/p2p/discover/v5wire"
...
func (test *udpV5Test) packetInFrom(key *crypto.PrivateKey, addr *net.UDPAddr, packet v5wire.Packet) {
	test.t.Helper()
...
func (test *udpV5Test) getNode(key *crypto.PrivateKey, addr *net.UDPAddr) *enode.LocalNode {
