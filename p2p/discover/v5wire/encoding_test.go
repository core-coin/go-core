...
var (
	testKeyA, _   = crypto.UnmarshalPrivateKeyHex("1033b1bac4c731e800b6399a357e51cf1b20eec942aac608c90b89553003e2ed3f94bd80613ee9006b1e62b6bb45109d0db9a4833e78363992")
	testKeyB, _   = crypto.UnmarshalPrivateKeyHex("1033b1bac4c731e800b6399a357e51cf1b20eec942aac608c90b89553003e2ed3f94bd80613ee9006b1e62b6bb45109d0db9a4833e78363991")
	testEphKey, _ = crypto.UnmarshalPrivateKeyHex("1033b1bac4c731e800b6399a357e51cf1b20eec942aac608c90b89553003e2ed3f94bd80613ee9006b1e62b6bb45109d0db9a4833e78363993")
...
func TestTestVectorsV5(t *testing.T) {
	...
	for _, test := range tests {
		...
		t.Run(test.name, func(t *testing.T) {
			...
			net.nodeA.c.sc.ephemeralKeyGen = func(read io.Reader) (*crypto.PrivateKey, error) {
...
func (n *handshakeTestNode) init(key *crypto.PrivateKey, ip net.IP, clock mclock.Clock) {
	db, _ := enode.OpenDB("")
