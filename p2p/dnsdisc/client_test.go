...
func TestClientSyncTree(t *testing.T) {
	r := mapResolver{
		"n": "enrtree-root:v1 e=QAO2PMLNIZU6HVN4OGDWWQ4UCQ l=LOOO2ZWKOLDJW2LQVMYL6UT77U seq=1 sig=kM4yRJJOqnIJOl5jGA0hLdXs20SftfC60uXko75KdcwORvFS6sq3rsf3qIYxiE_3ybQR98gNo7wAw8RBoKTyko1D_z8sqTkg39vUh7Mz2s9ZV22MUU1KFBnBBfI70P1X38u90TEdcR-8a_4KZ-f_zjYASnsKymLWBgRmVCKoPAQ5OAZITJYZuTbCaLUSZjp91KylRphiCcVVLJpwqIOG5K34ZndqiPAvZ0QA",
		...
		"QAO2PMLNIZU6HVN4OGDWWQ4UCQ.n":                           "enrtree-branch:KC4PLFMOX2LHMRJFOXFGW2HQ6DMKPEUBRE4WCFPWDNLST54TZAKA,7MY4MKNM3NJRQAB4FMQ3KYLPWHUL7NGPOMN7J4RAY3NZ2PSTMDBQ,VW3Q4GPAEDH6DLOYX4GQYUSFHKFHBUC4TRH2PZTH5SBAAQNE7P2A",
		...
		"RESRN326FX43MSLLCGJTO64QNE.n":                           "\t\t\"RESRN326FX43MSLLCGJTO64QNE.n\": \"enr:--GfSOKvs8lo1Hk0SQ0zomoRuhXMBLxPqWXhsGCWgSdG-8cD9mMqjRxmKtuW7LwqmOa_BhzQEBHlfX6sIPLHEQ6i4c15sn2n5NWQZ2yHYf9geCMx5TllePNBLFhpJeOasP8Uv90XspWoW40v4X3u_sxtFNZQDTbUlXIIMO5_jkgtyzpHU69uHGttB6EAKCaWSCdjSJc2VjcDI1NmsxuDhTllePNBLFhpJeOasP8Uv90XspWoW40v4X3u_sxtFNZQDTbUlXIIMO5_jkgtyzpHU69uHGttB6EA",
	}
	var (
	...
	stree, err := c.SyncTree("enrtree://7MY4MKNM3NJRQAB4FMQ3KYLPWHUL7NGPOMN7J4RAY3NZ2PSTMDBQ@n")
	if err != nil {
