...
func TestClientSyncTree(t *testing.T) {
	r := mapResolver{
		...
		"NBR5UGUKPKHBEV6MNKYLWA76UA.n": "enrtree-branch:AZ2AA7473KDOKV7PC3GMHBXZSE,RESRN326FX43MSLLCGJTO64QNE,FFWEK2OQ5VIQR6UVZCTXPYTWI4",
		"HBRIBBF355HFMMLJX4ATX3PRRY.n": "enrtree://JJ5QVSTC2YDAIZSUEKUDYBBZHADEQTEWDG4TNQTIWUJGMOT52SWKKRUYMIE4KVJMTJYKRA4G4SW7QZTXNKEPAL3HIQAA@morenodes.example.org",
		"n":                            "enrtree-root:v1 e=NBR5UGUKPKHBEV6MNKYLWA76UA l=HBRIBBF355HFMMLJX4ATX3PRRY seq=1 sig=0-nBiy1P3GB-CsXUL4vR_WKoY7UK0bYIjFCvhrxTd64A_Cg1Y3UOPQpWo-FLdLdEHWbri-xL_ocAS7yG_Mn8-QCmQZAG_7apeT9NYp4dAbscIdX0J1YJdjxeWSVN1t4UU5a5ixdkNHfOthEtGN8TjSIAhR3c_l0JEw3XUFpFrCjAQu-MCmR7bhcFQ_-KFwrG6r_1oQ2Q_-glxs9NYZz2ueAgQ8Lm0te4tZsA",
	}
	var (
		wantNodes = testNodes(0x29452, 3)
		wantLinks = []string{"enrtree://JJ5QVSTC2YDAIZSUEKUDYBBZHADEQTEWDG4TNQTIWUJGMOT52SWKKRUYMIE4KVJMTJYKRA4G4SW7QZTXNKEPAL3HIQAA@morenodes.example.org"}
		wantSeq   = uint(1)
	)

	c := NewClient(Config{Resolver: r, Logger: testlog.Logger(t, log.LvlTrace)})
	stree, err := c.SyncTree("enrtree://QUO5Z7S5BEJQ3V2QLJC2YKGAILXYYCTEPNXBOBKD76FBOCWG5K77LIINSD76QJOGZ5GWDHHWXHQCAQ6C43JNPOFVTMAA@n")
	if err != nil {
