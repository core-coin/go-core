...
func TestProtocolHandshake(t *testing.T) {
	var (
		prv0, _ = crypto.GenerateKey(crand.Reader)
		hs0     = &protoHandshake{Version: 3, ID: prv0.PublicKey()[:], Caps: []Cap{{"a", 0}, {"b", 2}}}

		prv1, _ = crypto.GenerateKey(crand.Reader)
		hs1     = &protoHandshake{Version: 3, ID: prv1.PublicKey()[:], Caps: []Cap{{"c", 1}, {"d", 3}}}
