...
var protocolLengths = map[uint]uint64{xcb65: 17, xcb64: 17, xcb63: 17}
...
// statusData63 is the network packet for the status message for xcb/63.
...
// statusData is the network packet for the status message for xcb/64 and later.
