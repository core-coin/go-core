...
var (
	...
	txFetcherFetchingPeers  = metrics.NewRegisteredGauge("xce/fetcher/transaction/fetching/peers", nil)
	txFetcherFetchingHashes = metrics.NewRegisteredGauge("xce/fetcher/transaction/fetching/hashes", nil)
)
