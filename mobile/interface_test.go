...
func TestInterfaceGetSet(t *testing.T) {
	deadbeef, err := common.HexToAddress("cc3212345678123456781234567812345678deadbeef")
	if err != nil {
		t.Error(err)
	}
	cafebabe, err := common.HexToAddress("cc2412345678123456781234567812345678cafebabe")
	if err != nil {
		t.Error(err)
	}
	var tests = []struct {
