...
func TestUnpackIndexedStringTyLogIntoMap(t *testing.T) {
	...
	address, err := common.HexToAddress("cb540000000000000000000000000000000000000000")
	if err != nil {
		t.Error(err)
	}
	...
	address2, err := common.HexToAddress("cb63376c47978271565f56deb45495afa69e59c16ab2")
	if err != nil {
		t.Error(err)
	}
...
func TestUnpackIndexedArrayTyLogIntoMap(t *testing.T) {
	...
	addressNotEmpty, err := common.HexToAddress("cb63376c47978271565f56deb45495afa69e59c16ab2")
	if err != nil {
		t.Error(err)
	}
...
func TestUnpackIndexedFuncTyLogIntoMap(t *testing.T) {
	...
	empty, err := common.HexToAddress("cb540000000000000000000000000000000000000000")
	if err != nil {
		t.Error(err)
	}
	mockLog := types.Log{
