...
var bindTests = []struct {
	...
	// Test that constant functions can be called from an (optional) specified address
	{
		...
		`
			...
			addr1, _ := common.HexToAddress("cb970000000000000000000000000000000000000000")
			addr2, _ := common.HexToAddress("cb960000000000000000000000000000000000000001")
			addr3, _ := common.HexToAddress("cb950000000000000000000000000000000000000002")
	...
	// Tests that logs can be successfully filtered and decoded.
	{
		...
		`
			...
			addr0, _ := common.HexToAddress("cb970000000000000000000000000000000000000000")
			addr1, _ := common.HexToAddress("cb960000000000000000000000000000000000000001")
			addr2, _ := common.HexToAddress("cb950000000000000000000000000000000000000002")
			addr3, _ := common.HexToAddress("cb940000000000000000000000000000000000000003")
