...
func ExampleJSON() {
	...
	fmt.Printf("%x\n", out)
	// Output:
	// 1f2c409200000000000000000000cb960000000000000000000000000000000000000001
}
...
func TestUnpackEventIntoMap(t *testing.T) {
	...
	const hexdata = ``
	data, err := hex.DecodeString(hexdata)
	if err != nil {
		t.Fatal(err)
	}
...
func TestUnpackIntoMapNamingConflict(t *testing.T) {
	...
	hexdata = ``
	data, err = hex.DecodeString(hexdata)
	if err != nil {
		t.Fatal(err)
	}
