...
func ExampleJSON() {
	...
	addr, err := common.HexToAddress("cc960000000000000000000000000000000000000001")
	if err != nil {
		panic(err)
	}
	...
	fmt.Printf("%x\n", out)
	// Output:
	// 1f2c409200000000000000000000cc960000000000000000000000000000000000000001
}
...
func TestUnpackEventIntoMap(t *testing.T) {
	...
	const hexdata = ``
	data, err := hex.DecodeString(hexdata)
	if err != nil {
		t.Fatal(err)
	}
...
func TestUnpackIntoMapNamingConflict(t *testing.T) {
	...
	hexdata = ``
	data, err = hex.DecodeString(hexdata)
	if err != nil {
		t.Fatal(err)
	}
