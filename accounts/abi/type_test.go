...
func TestTypeRegexp(t *testing.T) {
	tests := []struct {
		...
		{"address", nil, Type{Kind: reflect.Array, Type: addressT, Size: 21, T: AddressTy, stringKind: "address"}},
		{"address[]", nil, Type{T: SliceTy, Kind: reflect.Slice, Type: reflect.TypeOf([]common.Address{}), Elem: &Type{Kind: reflect.Array, Type: addressT, Size: 21, T: AddressTy, stringKind: "address"}, stringKind: "address[]"}},
		{"address[2]", nil, Type{Kind: reflect.Array, T: ArrayTy, Size: 2, Type: reflect.TypeOf([2]common.Address{}), Elem: &Type{Kind: reflect.Array, Type: addressT, Size: 21, T: AddressTy, stringKind: "address"}, stringKind: "address[2]"}},
