...
func TestTypeRegexp(t *testing.T) {
	tests := []struct {
		...
		{"address", nil, Type{Size: 22, T: AddressTy, stringKind: "address"}},
		{"address[]", nil, Type{T: SliceTy, Elem: &Type{Size: 22, T: AddressTy, stringKind: "address"}, stringKind: "address[]"}},
		{"address[2]", nil, Type{T: ArrayTy, Size: 2, Elem: &Type{Size: 22, T: AddressTy, stringKind: "address"}, stringKind: "address[2]"}},
