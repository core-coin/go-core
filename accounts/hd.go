...
// are appended. As such, the first account will be at m/44'/654'/0'/0, the second
// at m/44'/654'/0'/1, etc.
var DefaultRootDerivationPath = DerivationPath{0x80000000 + 44, 0x80000000 + 654, 0x80000000 + 0, 0}

// DefaultBaseDerivationPath is the base path from which custom derivation endpoints
// are incremented. As such, the first account will be at m/44'/654'/0'/0/0, the second
...
// the `coin_type` 654' (or 0x8000028e) to Core.
//
// The root path for Core is m/44'/654'/0'/0 according to the specification
// from https://github.com/core-coin/CIPs/issues/84, albeit it's not set in stone
