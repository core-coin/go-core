...
func TestTransaction(t *testing.T) {
	...
	// We don't allow more than uint64 in energy amount
	// This is a pseudo-consensus vulnerability, but not in practice
	// because of the energy limit
	txt.skipLoad("^ttEnergyLimit/TransactionWithEnergyLimitxPriceOverflow.json")
	// We _do_ allow more than uint64 in energy price, as opposed to the tests
